...
python auralis_lab/llm.py --engine ollama --model qwen3:8b --prompt "现在外面多少度，路况怎么样？"
...
- Without a supplied data source, it does not fabricate real-time weather, traffic, price, news, or similar facts.
